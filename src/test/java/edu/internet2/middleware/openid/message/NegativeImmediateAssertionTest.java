 ...
 */
public class NegativeImmediateAssertionTest extends BaseMessageProviderTestCase {

    /** Logger. */
    private final Logger log = LoggerFactory.getLogger(NegativeImmediateAssertionTest.class);

    /** Expected mode. */
    private String expectedMode;

    /** Constructor. */
    public NegativeImmediateAssertionTest() {
        messageFile = "/data/edu/internet2/middleware/openid/message/NegativeImmediateAssertion.txt";
    }
    ...
    public void setUp() throws Exception {
        ...
        expectedMode = NegativeAssertion.MODE_IMMEDIATE;
    }
