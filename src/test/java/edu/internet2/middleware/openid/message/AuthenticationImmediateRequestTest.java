 ...
 */
public class AuthenticationImmediateRequestTest extends BaseMessageProviderTestCase {

    /** Logger. */
    private final Logger log = LoggerFactory.getLogger(AuthenticationImmediateRequestTest.class);
    ...
    /** Constructor. */
    public AuthenticationImmediateRequestTest() {
        messageFile = "/data/edu/internet2/middleware/openid/message/AuthenticationImmediateRequest.txt";
    }
    ...
    public void setUp() throws Exception {
        ...
        expectedMode = AuthenticationRequest.MODE_IMMEDIATE;
