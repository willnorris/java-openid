...
/**
 * Abstract base implementation of {@link AssociationStore}.
 */
public abstract class AbstractAssociationStore implements AssociationStore {

    /** {@inheritDoc} */
    public void invalidate(Association association) {
        invalidate(association.getHandle());
    }

    /** {@inheritDoc} */
    public void remove(Association association) {
        remove(association.getHandle());
    }
