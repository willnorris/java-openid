...
/**
 * Builder of {@link StoreRequest} message extensions.
 */
public class StoreRequestBuilder implements MessageExtensionBuilder<StoreRequest> {

    /** {@inheritDoc} */
    public StoreRequest buildObject() {
        return new StoreRequestImpl();
    }
