...
/**
 * Builder of {@link StoreResponse} message extensions.
 */
public class StoreResponseBuilder implements MessageExtensionBuilder<StoreResponse> {

    /** {@inheritDoc} */
    public StoreResponse buildObject() {
        return new StoreResponseImpl();
    }
