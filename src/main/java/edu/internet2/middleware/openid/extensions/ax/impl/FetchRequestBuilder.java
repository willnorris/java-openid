...
/**
 * Builder of {@link FetchRequest} message extensions.
 */
public class FetchRequestBuilder implements MessageExtensionBuilder<FetchRequest> {

    /** {@inheritDoc} */
    public FetchRequest buildObject() {
